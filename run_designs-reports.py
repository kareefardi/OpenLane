    ...
    def run_design(designs_queue):
        ...
        while not designs_queue.empty():
            ...
            try:
                ...
                update("INFO", design, f"{tag} | generating report: {os.path.relpath(run_path)}/report.csv")
                ...
                update("ERROR", design, f"{tag} | report: {os.path.relpath(run_path)}/report.csv not found")
                pass
